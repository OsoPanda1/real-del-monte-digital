...
export interface NarrativeEntry {
  ...
  tags: string[];
  createdAt: Date;
  references: string[]; // podría incluir DOIs, IDs de repos, etc.
  /**
...
export interface ProtocolCommand {
  ...
  priority?: number;
  /**
   * Optional reference to a territorial context (route, POI, etc.).
   */
...
export interface UIState<T = unknown> {
  ...
  data?: T;
  /**
   * Ultima actualización para este estado, útil para cache y revalidación.
   */
  updatedAt?: Date;
}
